import { VanillaExtractPlugin as VanillaExtractPluginCurrent } from '@vanilla-extract/webpack-plugin';
...
export const startWebpackFixture = (
  ...
  new Promise(async (resolve) => {
    ...
    const VanillaExtractPlugin = type.includes('next')
      ? VanillaExtractPluginNext
      : VanillaExtractPluginCurrent;
