...
describe('compiler', () => {
  ...
  test('recipes class names', async () => {
    ...
    expect(output.source).toMatchInlineSnapshot(`
      ...
      export var recipeWithReferences = _7a468({baseClassName:'recipeClassNames_recipeWithReferences__129pj258',defaultClassName:'recipeClassNames_recipeWithReferences__129pj258',variantClassNames:{first:{true:'recipeClassNames_recipeWithReferences_first_true__129pj259'}},defaultVariants:{},compoundVariants:[]});"
    `);
